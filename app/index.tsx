import { CURRENCY_SYMBOL, FONT_SIZE_LARGE, FONT_SIZE_REGULAR, FONT_SIZE_XLARGE, getLongDateText, scaleFontSize } from '@/util/util';
...
const CategoryScreen = () => {
    ...
    }, [_setDate, context.actions])

    const setLatestDate = useCallback(() => {
        let today = new Date();
    ...
    }, [context.transactions, setDate]);

    useEffect(() => {
        setLatestDate();
    }, [isFocused, setLatestDate]);
            ...
            <View style={styles.screen}>
                {/* <View style={styles.topBar}>
                    <View style={styles.dateBar}>
                        ...
                        >
                            ...
                            <Text style={{ color: 'white', fontSize: FONT_SIZE_MINI }}>Today</Text>
                        </TouchableOpacity>
                        <View style={styles.topBarDateIcons}>
                            <TouchableOpacity
                                ...
                                <Text style={{ color: 'white', fontSize: FONT_SIZE_MINI }}>Latest</Text>
                            </TouchableOpacity>
                        </View>
                         <DatePicker
                ...
                <View style={styles.header}>
                    ...
                    >
                        ...
                        <Text style={styles.header_date}>{getLongDateText(date)}</Text>
                    </TouchableOpacity>
                </View>
